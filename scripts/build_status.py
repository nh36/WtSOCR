...
def build_family_rows(stats: ReleaseStats) -> list[dict[str, str]]:
    ...
    rows = [
        ...
        row(
            ...
            "partially_applied",
            "all",
            "confusable_nya_coda_safe;confusable_nya_coda_safe_strong_context;reviewed_tibetan_exact_final_ng;reviewed_tibetan_exact_final_ng_consensus;reviewed_tibetan_exact_script_ng_witness;reviewed_tibetan_exact_residual_ng;reviewed_tibetan_exact_residual_spacing_ng",
            "scripts/postprocess_entry_map.py;data/reviewed_tibetan_exact_overrides.tsv",
            "docs/tibetan_script_ng_witness_sweep_2026-06-28.md;release/current/qa",
            reason_sum(stats, "confusable_nya_coda_safe", "reviewed_tibetan_exact_final_ng", "reviewed_tibetan_exact_final_ng_consensus", "reviewed_tibetan_exact_script_ng_witness", "reviewed_tibetan_exact_residual_ng", "reviewed_tibetan_exact_residual_spacing_ng"),
            final_ng_residual,
            "broad ń->ṅ;broad n->ṅ",
